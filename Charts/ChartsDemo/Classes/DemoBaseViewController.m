...
//     this is the "by daniel cohen gindi thingy" 
    NSMutableAttributedString *centerText = [[NSMutableAttributedString alloc] initWithString:@"LifeTime\nby Daekun Kim & Danny Lee"];
    ...
    [centerText addAttributes:@{
                                ...
                                } range:NSMakeRange(centerText.length - 23, 23)];
